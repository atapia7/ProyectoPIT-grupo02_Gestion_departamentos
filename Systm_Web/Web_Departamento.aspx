<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Web_Departamento.aspx.cs" Inherits="Systm_Web.Web_Departamento" %>
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <!-- dividir ventana -->
                 ...
                 <div class="form-group">
                  <label for="exampleInputEmail1">N° Departamento</label>
               
                                          <asp:TextBox ID="txtnumero"  class="form-control"  placeholder="Ingrese Numero Departamento" runat="server" ></asp:TextBox>
           ...
           <div class="form-group">
                  <label for="exampleInputEmail1">N° Edificio</label>


                     
                    <asp:DropDownList ID="cboedificio" class="form-control" runat="server" >
                 ...
                 <div class="form-group">
                  ...
                  <label for="exampleInputEmail1">Area</label>
                     ...
                     <asp:TextBox ID="txtarea"  class="form-control"  placeholder="Ingrese Area" runat="server" ></asp:TextBox>
            ...
            <div class="col-md-6">
              ...
              <!-- dividir ventana -->
                 ...
                 <div class="form-group">
                  ...
                  <asp:TextBox ID="txtpiso"  class="form-control"  placeholder="Ingrese Numero Piso" runat="server" ></asp:TextBox>
                 ...
                 <div class="form-group">
                  <label for="exampleInputEmail1">N° Estacionamiento</label>
               
                                        
                 
                  <asp:TextBox ID="txtestacionamiento"  class="form-control"  placeholder="Ingrese Numero Estacionamiento" runat="server" ></asp:TextBox>
                 ...
                 <div class="form-group">
                  <label for="exampleInputEmail1">Fecha</label>
                                          ...
                                          <asp:TextBox ID="txtfecha"  class="form-control"  placeholder="Ingrese Fecha" TextMode="Date" runat="server" ></asp:TextBox>
