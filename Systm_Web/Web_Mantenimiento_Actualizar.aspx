<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Web_Mantenimiento_Actualizar.aspx.cs" Inherits="Systm_Web.Web_Mantenimiento_Actualizar" %>
          ...
          <div class="row">
            <div class="auto-style7">
              ...
              <!-- dividir ventana -->
               ...
               <asp:TextBox ID="txtservicio"  class="form-control"  placeholder="Ingrese Descripcion" runat="server" ></asp:TextBox>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <asp:TextBox ID="txtpropietario"  class="form-control"  placeholder="Ingrese Descripcion" runat="server" ></asp:TextBox>
