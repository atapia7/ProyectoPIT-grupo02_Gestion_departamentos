<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Web_Propietario.aspx.cs" Inherits="Systm_Web.Web_Propietario" %>
            ...
            <div class="col-md-6">
              ...
              <!-- dividir ventana -->
                 ...
                 <div class="form-group">
                  <label for="exampleInputEmail1">Fecha</label>
                                          ...
                                          <asp:TextBox ID="txtciudad"  class="form-control"  placeholder="Ingrese Fecha" TextMode="Date" runat="server" ></asp:TextBox>
              ...
              <div class="form-group">
                 ...
                 <div class="form-group">
                     ...
                     <asp:Label ID="txtcodigo" runat="server" CssClass="auto-style7"></asp:Label>
