<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Web_Consulta_Personas.aspx.cs" Inherits="Systm_Web.Web_Consulta_Personas" %>
...
<br>
       ...
       <asp:GridView ID="GridView1" runat="server" CellPadding="3" Width="978px" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CssClass="auto-style9" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                                ...
                                <Columns>
                                    ...
                                    <asp:CommandField HeaderText="Seleccionar" ShowSelectButton="True" ButtonType="Button" DeleteText="Enviar" SelectText="Enviar" >
