<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Web_Visita_Actualizar.aspx.cs" Inherits="Systm_Web.Web_Visita_Actualizar" %>
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title"></h3>
            ...
            <asp:Label ID="txtcodigo" runat="server" style="color: #FFFFFF; font-family: Arial"></asp:Label>
          ...
          <div class="row">
           ...
           <div class="form-group">
                  ...
                  <label for="exampleInputEmail1">N°</label>
                    ...
                    <asp:TextBox ID="txtcodpersona"  class="form-control"  placeholder="" runat="server" ></asp:TextBox>
           ...
           <div class="form-group">
                  ...
                  <label for="exampleInputEmail1">Persona</label>
                    ...
                    <asp:TextBox ID="txtpersona"  class="form-control"  placeholder="" runat="server" ></asp:TextBox>
              ...
              <!-- dividir ventana -->
                     ...
                     <label for="exampleInputEmail1">Estado</label>
                                             ...
                                             <asp:DropDownList ID="cboestado" class="form-control"   placeholder="Seleccionar"  runat="server" >
                                                 <asp:ListItem>Salio</asp:ListItem>
