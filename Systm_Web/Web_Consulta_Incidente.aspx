<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Web_Consulta_Incidente.aspx.cs" Inherits="Systm_Web.Web_Consulta_Incidente" %>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="box">
                                    ...
                                    <table class="auto-style12">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox ID="TextBox1" runat="server" class="form-control pull-right" placeholder="Ingrese Nª Departamento" OnTextChanged="TextBox1_TextChanged" CssClass="auto-style8" Height="34px" Width="175px"></asp:TextBox>
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" CellPadding="3" Width="799px" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CssClass="auto-style9" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Height="90px">
                                    ...
                                    <ControlStyle BackColor="#66CCFF" BorderColor="#66CCFF" ForeColor="White" />
                                    <FooterStyle BackColor="#66FFFF" BorderColor="#66CCFF" />
                                    <HeaderStyle BorderColor="#CCFFFF" />
                                    </asp:CommandField>
                                </columns>
