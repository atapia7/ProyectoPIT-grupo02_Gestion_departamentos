<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Web_Persona.aspx.cs" Inherits="Systm_Web.Web_Persona" %>
              ...
              <!-- dividir ventana -->
                 ...
                 <div class="form-group">
                  <label for="exampleInputEmail1">Fecha</label>
                                          ...
                                          <asp:TextBox ID="txtciudad"  class="form-control" TextMode="Date"  placeholder="Ingrese Fecha" runat="server" ></asp:TextBox>
