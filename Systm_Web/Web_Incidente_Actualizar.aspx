<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Web_Incidente_Actualizar.aspx.cs" Inherits="Systm_Web.Web_Incidente_Actualizar" %>
  ...
  <div class="content-wrapper">
    ...
    <div class="form-group">
                  <label for="exampleInputEmail1">Codigo</label>
                       ...
                       <asp:TextBox ID="txtcodigo"  class="form-control"  placeholder="" runat="server" ></asp:TextBox>
           ...
           <div class="form-group">
                  <label for="exampleInputEmail1">N° Departamento</label>
                     ...
                     <asp:TextBox ID="txtdepartamento"  class="form-control"  placeholder="" runat="server" ></asp:TextBox>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                  ...
                  <asp:TextBox ID="txtcausa"  class="form-control"  placeholder="" runat="server" ></asp:TextBox>
