<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Web_Consulta_Visita.aspx.cs" Inherits="Systm_Web.Web_Consulta_Visita" %>
            ...
            <div class="box-header">
              ...
              <table class="auto-style12">
                  <tr>
                    ...
                    <asp:TextBox ID="TextBox1" runat="server" class="form-control pull-right" placeholder=""  OnTextChanged="TextBox1_TextChanged" CssClass="auto-style8" Height="34px" Width="213px" ></asp:TextBox>


                       
                          <asp:Button ID="Button2" runat="server" class="btn btn-success"  Text="Consultar" OnClick="Button1_Click" Height="40px" Width="101px" />
...
<br>
       ...
       <asp:GridView ID="GridView1" runat="server" CellPadding="3" Width="1026px" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CssClass="auto-style9" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                                ...
                                <Columns>
                                    <asp:CommandField ButtonType="Button" DeleteText="Seleccionar" HeaderText="Seleccionar" SelectText="Enviar" ShowSelectButton="True">
                                    <ControlStyle BackColor="#33CCFF" BorderColor="White" />
