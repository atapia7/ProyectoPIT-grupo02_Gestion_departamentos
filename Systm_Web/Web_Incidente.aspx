<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Web_Incidente.aspx.cs" Inherits="Systm_Web.Web_Incidente" %>
           ...
           <div class="form-group">
                  <label for="exampleInputEmail1">Estado</label>
                    ...
                    <asp:DropDownList ID="cboestado" class="form-control" runat="server" >
                        <asp:ListItem>No Atendido</asp:ListItem>
            ...
            <div class="col-md-6">
              ...
              <!-- dividir ventana -->
                  ...
                  <label for="exampleInputEmail1">Causa de Incidente</label>
