<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Web_Visita.aspx.cs" Inherits="Systm_Web.Web_Visita" %>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
          ...
          <div class="row">
              ...
              <!-- dividir ventana -->
                 ...
                 <div class="form-group">
                  <label for="exampleInputEmail1">N° Departamento</label>
                                ...
                                <asp:DropDownList ID="cbodepartamento" class="form-control" runat="server" >
           ...
           <div class="form-group">
                  ...
                  <label for="exampleInputEmail1">Persona</label>
                    ...
                    <asp:DropDownList ID="cbopersona" class="form-control" runat="server" >
             ...
             <asp:TextBox ID="txtentrada"  class="form-control"  placeholder="" runat="server" ></asp:TextBox>
    ...
    <div class="form-group">
             ...
             <asp:TextBox ID="txtsalidas"  class="form-control"  placeholder="Ingrese la Hora Salida" runat="server" ></asp:TextBox>
            ...
            <div class="col-md-6">
              ...
              <!-- dividir ventana -->
                     ...
                     <label for="exampleInputEmail1">Estado</label>
                                             ...
                                             <asp:DropDownList ID="cboestado" class="form-control"   placeholder="Seleccionar"  runat="server" >
                                                 <asp:ListItem>No Salio</asp:ListItem>
                  ...
                  <label for="exampleInputEmail1">Comentario</label>
                                          ...
                                          <asp:TextBox ID="txtcomentario"  class="form-control"  placeholder="Ingrese Comentario" runat="server" >.</asp:TextBox>
                ...
                <!-- /.input group -->
                 ...
                 <div class="form-group">
                  <label for="exampleInputEmail1">Fecha</label>
                                          ...
                                          <asp:TextBox ID="txtfecha"  class="form-control" TextMode="Date" placeholder="Ingrese Fecha" runat="server" ></asp:TextBox>
