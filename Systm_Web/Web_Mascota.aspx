<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Web_Mascota.aspx.cs" Inherits="Systm_Web.Web_Mascota" %>
              ...
              <!-- dividir ventana -->
                 ...
                 <div class="form-group">
                  <label for="exampleInputEmail1">Tipo</label>
                                          ...
                                          <asp:TextBox ID="txttipo"  class="form-control"  placeholder="Ingrese Tipo Mascota" runat="server" ></asp:TextBox>
           ...
           <div class="form-group">
                 ...
                 <div class="form-group">
                  <label for="exampleInputEmail1">Sexo</label>
                                          ...
                                          <asp:TextBox ID="txtsexo"  class="form-control"  placeholder="Ingrese Sexo" runat="server" ></asp:TextBox>
              ...
              <!-- dividir ventana -->
                 ...
                 <div class="form-group">
                  <label for="exampleInputEmail1">Raza</label>
                                          ...
                                          <asp:TextBox ID="txtraza"  class="form-control"  placeholder="Ingrese Raza" runat="server" ></asp:TextBox>
