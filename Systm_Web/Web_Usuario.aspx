<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Web_Usuario.aspx.cs" Inherits="Systm_Web.Web_Usuario" %>
              ...
              <!-- dividir ventana -->
                 ...
                 <div class="form-group">
                  <label for="exampleInputEmail1">Usuario</label>
                     ...
                     <asp:TextBox ID="txtusuario"  class="form-control"  placeholder="Ingrese Usuario " runat="server"></asp:TextBox>
                 ...
                 <div class="form-group">
                  <label for="exampleInputEmail1">Contraseña</label>
                                          ...
                                          <asp:TextBox ID="txtcontraseña"  class="form-control"  placeholder="Ingrese Contraseña" runat="server" ></asp:TextBox>
