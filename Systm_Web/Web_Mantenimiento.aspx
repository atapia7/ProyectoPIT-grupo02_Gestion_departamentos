<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Web_Mantenimiento.aspx.cs" Inherits="Systm_Web.Web_Mantenimiento" %>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <!-- search form -->
         Me<!-- /.search form --><!-- sidebar menu: : style can be found in sidebar.less --><ul class="sidebar-menu" data-widget="tree">
          ...
          <div class="row">
            <div class="auto-style7">
              ...
              <!-- dividir ventana -->
                   ...
                   <div class="form-group">
                  <label for="exampleInputEmail1">Nª Boleta</label>
               
                                          <asp:TextBox ID="txtcodigo"  class="form-control"  placeholder="Ingrese Descripcion" runat="server" ></asp:TextBox>
                 ...
                 <div class="form-group">
                  <label for="exampleInputEmail1">Mes</label>
                                          ...
                                          <asp:TextBox ID="txtdescripcion"  class="form-control"  placeholder="Ingrese Descripcion" runat="server" ></asp:TextBox>
           ...
           <div class="form-group">
                  <label for="exampleInputEmail1">Edificio</label>
                    ...
                    <asp:DropDownList ID="cbodepartamento" class="form-control" runat="server" OnSelectedIndexChanged="cbodepartamento_SelectedIndexChanged" OnTextChanged="cbodepartamento_TextChanged" >
                 ...
                 <div class="form-group">
                  <label for="exampleInputEmail1">Tipo Mantenimiento</label>
               
                                                
                    <asp:DropDownList ID="cbotipo" class="form-control" runat="server" >
            ...
            <div class="col-md-6">
              ...
              <!-- dividir ventana -->
                  ...
                  <label for="exampleInputEmail1">Monto</label>
                     ...
                     <asp:TextBox ID="txtmonto"  class="form-control"  placeholder="Ingrese Monto" runat="server" TextMode="Number" ></asp:TextBox>
                 ...
                 <div class="form-group">
                  <label for="exampleInputEmail1">Fecha</label>
                                          ...
                                          <asp:TextBox ID="txtfecha"  class="form-control"  placeholder="Ingrese Fecha"  runat="server" TextMode="Date" ></asp:TextBox>
              ...
              <div class="form-group">
                  <label for="exampleInputEmail1">Propietario</label>
                    ...
                    <asp:DropDownList ID="cbopropietario" class="form-control" runat="server" >
                  ...
                  <label for="exampleInputEmail1">Estado</label>
                    ...
                    <asp:DropDownList ID="cboestado" class="form-control" runat="server" >
                        <asp:ListItem>No Pagado</asp:ListItem>
...
<div class="box-footer">
    ...
    <asp:Button ID="Button1" runat="server" class="btn btn-success" Height="39px" Text="Registrar" Width="126px" OnClick="Button1_Click" />
                </label>

                   <label>      <asp:Button ID="Button4" runat="server" class="btn btn-warning" Height="39px" Text="Listado" Width="113px" OnClick="Button4_Click" />
