<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Web_Consulta_Mantenimiento.aspx.cs" Inherits="Systm_Web.Web_Consulta_Mantenimiento" %>
     ...
     <br>
              ...
              <table class="auto-style12">
                  <tr>
                    ...
                    <asp:TextBox ID="TextBox1" runat="server" class="form-control pull-right" placeholder="Ingrese el Propietario"  OnTextChanged="TextBox1_TextChanged" CssClass="auto-style8" Height="34px" Width="175px" ></asp:TextBox>
...
<br>
       ...
       <asp:GridView ID="GridView1" runat="server" CellPadding="3" Width="978px" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CssClass="auto-style9" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                                ...
                                <Columns>
                                    ...
                                    <ControlStyle BackColor="#66CCFF" ForeColor="White" BorderColor="#99CCFF" />
                                    <FooterStyle ForeColor="White" BackColor="#66CCFF" BorderColor="#66CCFF" />
                                    <HeaderStyle ForeColor="White" BorderColor="#66CCFF" />
                                    <ItemStyle BorderColor="#66CCFF" />
                                    </asp:CommandField>
                                </Columns>
